...
import com.zionex.t3series.web.view.v1_2.component.Action;
import com.zionex.t3series.web.view.v1_2.component.BPMNWebModeler;
import com.zionex.t3series.web.view.v1_2.component.Button;
import com.zionex.t3series.web.view.v1_2.component.CheckBox;
import com.zionex.t3series.web.view.v1_2.component.ComboBox;
import com.zionex.t3series.web.view.v1_2.component.Component;
import com.zionex.t3series.web.view.v1_2.component.Condition;
import com.zionex.t3series.web.view.v1_2.component.Container;
import com.zionex.t3series.web.view.v1_2.component.ContainerItem;
import com.zionex.t3series.web.view.v1_2.component.Data;
import com.zionex.t3series.web.view.v1_2.component.DatePicker;
import com.zionex.t3series.web.view.v1_2.component.Editor;
import com.zionex.t3series.web.view.v1_2.component.FileUpload;
import com.zionex.t3series.web.view.v1_2.component.Image;
import com.zionex.t3series.web.view.v1_2.component.InputBox;
import com.zionex.t3series.web.view.v1_2.component.KFileUpload;
import com.zionex.t3series.web.view.v1_2.component.Label;
import com.zionex.t3series.web.view.v1_2.component.Operation;
import com.zionex.t3series.web.view.v1_2.component.OperationCall;
import com.zionex.t3series.web.view.v1_2.component.Option;
import com.zionex.t3series.web.view.v1_2.component.Parameter;
import com.zionex.t3series.web.view.v1_2.component.Radio;
import com.zionex.t3series.web.view.v1_2.component.ReferenceOperationCall;
import com.zionex.t3series.web.view.v1_2.component.ReferenceServiceCall;
import com.zionex.t3series.web.view.v1_2.component.Scheduler;
import com.zionex.t3series.web.view.v1_2.component.ServiceCall;
import com.zionex.t3series.web.view.v1_2.component.Split;
import com.zionex.t3series.web.view.v1_2.component.SplitItem;
import com.zionex.t3series.web.view.v1_2.component.Tab;
import com.zionex.t3series.web.view.v1_2.component.TabItem;
import com.zionex.t3series.web.view.v1_2.component.Textarea;
import com.zionex.t3series.web.view.v1_2.component.Toolbar;
import com.zionex.t3series.web.view.v1_2.component.ToolbarButton;
import com.zionex.t3series.web.view.v1_2.component.Tree;
import com.zionex.t3series.web.view.v1_2.component.URLPage;
import com.zionex.t3series.web.view.v1_2.component.Window;
import com.zionex.t3series.web.view.v1_2.component.chart.Category;
import com.zionex.t3series.web.view.v1_2.component.chart.CategoryAxis;
import com.zionex.t3series.web.view.v1_2.component.chart.Chart;
import com.zionex.t3series.web.view.v1_2.component.chart.LabelsSeries;
import com.zionex.t3series.web.view.v1_2.component.chart.PieChart;
import com.zionex.t3series.web.view.v1_2.component.chart.Series;
import com.zionex.t3series.web.view.v1_2.component.chart.ValueAxis;
import com.zionex.t3series.web.view.v1_2.component.grid.Apply;
import com.zionex.t3series.web.view.v1_2.component.grid.Candidate;
import com.zionex.t3series.web.view.v1_2.component.grid.CellAttribute;
import com.zionex.t3series.web.view.v1_2.component.grid.Column;
import com.zionex.t3series.web.view.v1_2.component.grid.DateLimit;
import com.zionex.t3series.web.view.v1_2.component.grid.Grid;
import com.zionex.t3series.web.view.v1_2.component.grid.Iteration;
import com.zionex.t3series.web.view.v1_2.component.grid.TreeGrid;
import com.zionex.t3series.web.view.v1_2.component.grid.Validation;
...
public class ViewFactory implements ViewCreator {
    ...
    public Button createButton(Element element) {
        ...
        if (viewModel != null) {
            ...
            button.setProp("visible", ElementUtil.findBoolean(viewModel, "visible"));
    ...
    public Chart createChart(Element element) {
        ...
        if (viewModel != null) {
            ...
            chart.setProp("series-width", ElementUtil.findInteger(viewModel, "series-width"));
            ...
            chart.setProp(new String[] { "labels", "category-axis", "title", "text" }, ElementUtil.findString(viewModel, "labels", "category-axis", "title", "text"));
            chart.setProp(new String[] { "labels", "category-axis", "title", "font" }, ElementUtil.findString(viewModel, "labels", "category-axis", "title", "font"));
            chart.setProp(new String[] { "labels", "category-axis", "title", "color" }, ElementUtil.findString(viewModel, "labels", "category-axis", "title", "color"));
            chart.setProp(new String[] { "labels", "category-axis", "rotation" }, ElementUtil.findString(viewModel, "labels", "category-axis", "rotation"));

            chart.setProp(new String[] { "labels", "value-axis", "title", "text" }, ElementUtil.findString(viewModel, "labels", "value-axis", "title", "text"));
            chart.setProp(new String[] { "labels", "value-axis", "title", "font" }, ElementUtil.findString(viewModel, "labels", "value-axis", "title", "font"));
            chart.setProp(new String[] { "labels", "value-axis", "title", "color" }, ElementUtil.findString(viewModel, "labels", "value-axis", "title", "color"));
            chart.setProp(new String[] { "labels", "value-axis", "axis-crossing-value" }, ElementUtil.findString(viewModel, "labels", "value-axis", "axis-crossing-value"));
            chart.setProp(new String[] { "labels", "value-axis", "format" }, ElementUtil.findString(viewModel, "labels", "value-axis", "format"));
            chart.setProp(new String[] { "labels", "value-axis", "min" }, ElementUtil.findInteger(viewModel, "labels", "value-axis", "min"));
            chart.setProp(new String[] { "labels", "value-axis", "max" }, ElementUtil.findInteger(viewModel, "labels", "value-axis", "max"));

            chart.setProp(new String[] { "labels", "x-axis", "format" }, ElementUtil.findString(viewModel, "labels", "x-axis", "format"));
            chart.setProp(new String[] { "labels", "x-axis", "axis-crossing-value" }, ElementUtil.findString(viewModel, "labels", "x-axis", "axis-crossing-value"));
            chart.setProp(new String[] { "labels", "y-axis", "format" }, ElementUtil.findString(viewModel, "labels", "y-axis", "format"));

            Element labelsElement = viewModel.getChild("labels");
            if (labelsElement != null) {
                Element categoryAxisElement = labelsElement.getChild("category-axis");
                ...
                Element valueAxisElement = labelsElement.getChild("value-axis");
        ...
        if (model != null) {
            ...
            if (categoriesElement != null) {
                for (Element categoryElement : categoriesElement.getChildren("category")) {
                    ...
                    category.setProp("date-group", ElementUtil.findBoolean(categoryElement, "date-group"));
                    category.setProp("format", ElementUtil.findString(categoryElement, "format"));
                    category.setProp("sort-direction", ElementUtil.findString(categoryElement, "sort-direction"));
    ...
    public Grid createGrid(Element element) {
        ...
        if (viewModel != null) {
            ...
            grid.setProp("measure-column", ElementUtil.findString(viewModel, "measure-column"));
    ...
    public Tab createTab(Element element) {
        ...
        if (viewModel != null) {
            ...
            String position = ElementUtil.findString(viewModel, "position");
            if (position == null) {
                position = ElementUtil.findString(viewModel, "tabs", "position");
            }
    ...
    public Split createSplit(Element element) {
        ...
        if (viewModel != null) {
            ...
            String position = ElementUtil.findString(viewModel, "position");
            if (position == null) {
                position = ElementUtil.findString(viewModel, "splits", "position");
            }
    ...
    public Window createWindow(Element element) {
        ...
        if (viewModel != null) {
            ...
            window.setProp("use-buttons", ElementUtil.findBoolean(viewModel, "use-buttons"));
        }
